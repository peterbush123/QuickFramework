...
# 详细文档
更为详细的文档，[请在本项目的doc中查看](doc/1.快速入门.md)，由于个人原因，文档会逐步完成中，也同时欢迎进入我们的交流群中讨论，相互学习
...
## [3.8.6](https://gitee.com/top-discover/QuickFramework/tree/3.8.6)
3.8.6 分支为 creator 版本在>=3.8.6版本以上使用，为3.8.x的对外分支
## 其它分支为开发中或已经停止维护的分支，请不要轻易使用
