...
export default class UIView extends EventComponent {
    ...
    static logicType : ModuleClass<Logic> = null!;
    ...
    /**@description 关闭界面动画 */
    protected get closeAction() : Promise<void> | null{
        return null;
    } 
    ...
    protected get showAction() : Promise<void> | null{
        return null;
    }
    ...
    protected get hideAction() : Promise<void> | null{
        return null;
    }

    public hide( ) {
        const hideAction = this.hideAction;
        if ( hideAction ){
            hideAction.then(()=>{
