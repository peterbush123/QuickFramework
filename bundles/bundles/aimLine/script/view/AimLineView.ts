...
export default class AimLineView extends GameView {
    ...
    onLoad(){
        ...
        this.onN(this.graphics.node,Node.EventType.TOUCH_START,this.onTouchStart);
        this.onN(this.graphics.node,Node.EventType.TOUCH_MOVE,this.onTouchMove);
        this.onN(this.graphics.node,Node.EventType.TOUCH_END,this.onTouchEnd);
        this.onN(this.graphics.node,Node.EventType.TOUCH_CANCEL,this.onTouchEnd);
    }
