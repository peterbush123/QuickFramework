...
import { _decorator,Node,Animation, EventKeyboard, Tween, Vec3, randomRangeInt, UITransform, instantiate, BoxCollider2D, Rect, Size, randomRange, tween, macro, Sprite, size, Widget, KeyCode } from "cc";
...
import { TankBattleGameData } from "../data/TankBattleGameData";
 ...
 export default class TankBattleMapCtrl {
    ...
    private get logic():TankBattleLogic{
        return App.logicManager.get<TankBattleLogic>(this.data.module) as any;
    }
